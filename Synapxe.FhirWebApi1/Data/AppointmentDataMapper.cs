    ...
    public sealed class AppointmentDataMapper : IFhirDataMapper<AppointmentModel, Appointment>
    {
        public AppointmentModel ReverseMap(Appointment appointment)
        {
            return new AppointmentModel
            {
                ...
                End = appointment.End,
                CancellationReason = appointment.CancelationReason?.Coding.FirstOrDefault()?.Code ?? appointment.CancelationReason?.Text,
        ...
        public Appointment Map(AppointmentModel data)
        {
            ...
            {
                appointment.CancelationReason = new CodeableConcept { Coding = new List<Coding> { new Coding { Code = data.CancellationReason } } };
            }
